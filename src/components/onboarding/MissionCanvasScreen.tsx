...
import { Heart, Target, Palette, ChevronLeft, ChevronRight } from "lucide-react";
import { cn } from "@/lib/utils";

interface MissionCanvasScreenProps {
  onNext: () => void;
  onBack: () => void;
  onSkip: () => void;
}

const MissionCanvasScreen = ({ onNext, onBack, onSkip }: MissionCanvasScreenProps) => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Your life is a canvas - every habit is a brushstroke creating your masterpiece"
    }
  ];
...
export default MissionCanvasScreen;