...
const Header = () => {
  ...
  return (
    <header className="py-4 sm:py-6 px-4 sm:px-5 flex items-center justify-between max-w-3xl mx-auto w-full border-b border-green-100 sticky top-0 bg-white z-10">
      ...
      <div className="flex-1 flex justify-end">
        <Button 
          variant="outline" 
          className="text-green-800 border-green-200 hover:bg-green-50 rounded-full h-8 w-8 sm:h-9 sm:w-9 p-0"
          size="icon"
        >
