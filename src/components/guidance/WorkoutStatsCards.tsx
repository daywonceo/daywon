    ...
    <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
      <Card className="glass-card group hover:scale-105 transition-all duration-300 relative overflow-hidden">
        ...
        <CardContent className="p-4 text-center relative z-10">
          <div className="relative">
            ...
            <Target className="w-6 h-6 mx-auto mb-2 text-primary relative z-10 group-hover:scale-110 transition-transform duration-300" />
          </div>
          <div className="text-3xl font-bold text-primary mb-1 group-hover:text-primary/90 transition-colors">
            {completedThisWeek}
          </div>
      ...
      <Card className="glass-card group hover:scale-105 transition-all duration-300 delay-75 relative overflow-hidden">
        ...
        <CardContent className="p-4 text-center relative z-10">
          <div className="relative">
            <div className="absolute inset-0 bg-primary/20 rounded-full blur-md opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
            <Clock className="w-6 h-6 mx-auto mb-2 text-primary relative z-10 group-hover:scale-110 transition-transform duration-300" />
          </div>
          <div className="text-3xl font-bold text-primary mb-1 group-hover:text-primary/90 transition-colors">
            {averageMinutes}
          </div>
      ...
      <Card className="glass-card col-span-2 sm:col-span-1 group hover:scale-105 transition-all duration-300 delay-150 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-primary/10 via-transparent to-primary/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
        <CardContent className="p-4 text-center relative z-10">
          <div className="relative">
            <div className="absolute inset-0 bg-primary/20 rounded-full blur-md opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
            <TrendingUp className="w-6 h-6 mx-auto mb-2 text-primary relative z-10 group-hover:scale-110 transition-transform duration-300" />
          </div>
          <div className="text-3xl font-bold text-primary mb-1 group-hover:text-primary/90 transition-colors">
            {totalCompletedWorkouts}
          </div>
