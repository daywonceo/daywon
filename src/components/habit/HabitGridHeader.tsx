...
const HabitGridHeader: React.FC<HabitGridHeaderProps> = ({ habits }) => (
  <>
    {/* Date label aligned with habit headers */}
    <div className="text-center flex items-end justify-center min-h-[1.5rem]">
      <span className="text-xs sm:text-sm px-0.5 leading-tight font-semibold text-primary">
        Date
      </span>
    </div>
