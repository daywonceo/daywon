...
const ProfileActions = ({ onOpenSettings, onSignOut }: ProfileActionsProps) => {
  ...
  return (
    <div className="grid grid-cols-2 gap-4">
      ...
      <Button 
        variant="outline" 
        className="glass-card border-primary/20 hover:border-primary/40 hover:bg-primary/10 group h-14 relative overflow-hidden flex items-center justify-center"
